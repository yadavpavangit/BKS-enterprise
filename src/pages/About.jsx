    ...
    <section className="min-h-dvh">
      ...
      <div className="w-full bg-white/20 py-10">
        <div className="flex flex-col items-center justify-center gap-4 max-w-[80rem] w-full mx-auto px-6 md:px-10">
          ...
          <button className="px-6 py-2 bg-red-600 text-white rounded text-xl font-semibold mt-6 hover:bg-red-800 active:scale-95 transition-all duration-200 flex items-center gap-2">
            Contact Us <RiArrowRightLongLine size={30} />
          </button>
        </div>
      </div>
